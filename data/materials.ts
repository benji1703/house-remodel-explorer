...
export const materialCards: MaterialCard[] = [
  {
    ...
    description: "Narrow oak boards with visible grain and quiet joints that catch grazing light without reading as stripes.",
  ...
  },
  {
    ...
    description: "Quiet grain and softened joints let changing daylight reveal the pattern without drawn borders.",
    image: "/textures/herringbone-parquet-ao-2k.jpg",
    alt: "Ambient occlusion layer for oak herringbone parquet",
    specification: "Aligned board pattern",
  ...
  },
  {
    ...
    description: "Small-leaf evergreen volume with restrained white flowering, layered for a collected Mediterranean garden.",
