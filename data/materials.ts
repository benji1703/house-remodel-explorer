...
export const materialCards: MaterialCard[] = [
  ...
  },
  {
    ...
    description: "Small-leaf evergreen volume with restrained white flowering, built from scanned geometry rather than repeated radial leaves.",
    image: "/textures/jasmine-foliage.png",
    alt: "Star jasmine foliage with small white flowers",
    specification: "Layered Mediterranean planting",
