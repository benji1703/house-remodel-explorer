...
export const materialCards: MaterialCard[] = [
  ...
  },
  {
    ...
    family: "Floor",
    title: "Warm sand microtopping",
    description: "A seamless mineral floor keeps the north kitchen calm and generous, carrying the travertine tone from the island into the walking space.",
    image: "/textures/jerusalem-stone-ai.jpg",
    alt: "Warm sand mineral surface for the kitchen floor",
    specification: "Continuous 3 mm system",
    finish: "Matte mineral sealer",
    format: "landscape",
    moods: ["north-extension"],
  },
  {
    id: "lime-plaster",
    family: "Walls",
