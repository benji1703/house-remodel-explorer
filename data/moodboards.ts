...
export const roomMoodBoards: RoomMoodBoard[] = [
  ...
  },
  {
    ...
    images: [
      ...
      img("/references/moods/mood-east-upper-study.png", "Reading niche", "Pale oak writing desk and linen chair beside the Belgian window"),
      img("/references/moods/mood-east-upper-window.png", "Window detail", "Belgian window and timber shutters in morning light"),
      img("/references/moods/mood-east-upper-08.jpeg", "Bedside", "Oak nightstand and lamp"),
      img("/references/moods/mood-east-upper-07.jpeg", "Floor", "Oak herringbone floor in morning light"),
